...
I will not pretend to anything other than being a curious explorer and this is new terrain that probably harbors wild beasts that will destroy anything that attempts to actually do this. And it is probably also a bad idea, but for the intrepid and equally-crazy I present:
